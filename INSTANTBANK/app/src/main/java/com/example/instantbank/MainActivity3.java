...
public class MainActivity3 extends AppCompatActivity {
    ...
    Button button3, button6, button7, button8, button9, button10,button22;
...
//        String balanceRemaining = balance.getText().toString();
//        Integer balance_remaining = Integer.parseInt(balanceRemaining);
//
//        if(balance_remaining < 1000) {
//            Toast.makeText(this, "Your Balance is running low! Consider making a deposit", Toast.LENGTH_SHORT).show();
//        }
//        return balance;
//    }
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(accountBalance >= amountDeductable) {
                    ...
                    Toast.makeText(MainActivity3.this, "You have insufficient Balance in your Account!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(accountBalance >= amountDeductable) {
                    ...
                    Account manageBalance = new Account();
//                    String accountBalance2 = textView2.getText().toString();
                    manageBalance.AccountBalanceChecker(account_balance);
