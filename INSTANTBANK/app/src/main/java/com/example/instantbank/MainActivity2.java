...
//                }
                    ...
                    to the methods in Customer class */
                                        ...
                                        alert.append("We as INSTANT Bank are dedicated to keeping your account safe at all times. If you feel like you have an issue" +
       ...
       button5.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View view) {
                  int phoneNumber = Integer.parseInt(editTextTextPersonName3.getText().toString().trim());
                  int idNumber = Integer.parseInt(editTextTextPersonName6.getText().toString().trim());
                  int accountNumber =Integer.parseInt(editTextTextPersonName8.getText().toString().trim());

                  customer.setFirstName(editTextTextPersonName.getText().toString().trim());
                  customer.setLastName(editTextTextPersonName2.getText().toString().trim());
                  customer.setPhoneNumber(phoneNumber);
                  customer.setIdNumber(idNumber);
                  customer.setAccountNumber(accountNumber);
                  reff.push().setValue(customer);
                  Toast.makeText(MainActivity2.this,"Customer details saved",Toast.LENGTH_SHORT).show();
